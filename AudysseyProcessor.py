...
class AudysseyProcessor:
    ...
    def create_channel_data():
        ...
        corrections_rear = ["{20.0, 10.0}", "{50.0, 8.0}", "{100.0, 5.0}",  # low end
                            "{200.0, 2.0}", "{400.0, 0.0}", "{650.0, 0.5}",  # mid range
                            "{1000.0, 0.0}",  # zero crossing
                            "{1150.0, 0.0}", "{1500.0, -2.0}", "{1750.0, 2.0}",  # high shape 1
                            "{3500.0, 0.0}", "{6000.0, 0.0}",  # high shape 2
                            "{7000.0, -4.0}", "{12000.0, -0.5}",  # high shape 3
                            "{20000.0, -2.0}"  # high end
                            ]
