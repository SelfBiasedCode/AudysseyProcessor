...
class AudysseyProcessor:
    ...
    def create_channel_data():
        ...
        corrections_front = ["{20.0, 9.5}", "{50.0, 8.0}", "{125.0, 1.0}", "{250.0, 0.0}",
        ...
        corrections_rear = ["{20.0, 0.0}", "{80.0, 5.0}", "{200.0, 2.0}", "{400.0, 0.0}", "{650.0, 0.5}",
                            "{1500.0, -0.5}", "{4000.0, 0.0}", "{7000.0, -1.0}", "{12000.0, -0.5}", "{20000.0, -2.0}"]
